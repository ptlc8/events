...
<template>
  ...
  <svg width="56" height="56" viewbox="0 0 56 56">
    ...
    <g id="fog" v-if="fog">
      <line x1="16" y1="38" x2="40" y2="38" stroke="#D0D0D0B0" stroke-width="4" stroke-linecap="round" stroke-dasharray="11 5 8" />
      <line x1="14" y1="45" x2="40" y2="45" stroke="#D0D0D0B0" stroke-width="4" stroke-linecap="round" stroke-dasharray="5 6 13" />
    </g>
    <g id="small-cloud" v-if="clouds % 2 >= 1">
      <g transform="translate(16,6)">
      ...
      <g transform="translate(16,6)">
        <g class="am-weather-cloud-2">
          <path
            ...
            :fill="cloudColor" stroke="white" stroke-linejoin="round" stroke-width="1.2" transform="translate(-20,-11)" />
        </g>
      </g>
    </g>
    <g id="rain-3" v-if="rain >= 3">
      <g transform="translate(27,42), rotate(10)">
        <line class="am-weather-rain-1" fill="none" stroke="#91C0F8" stroke-dasharray="4,4" stroke-linecap="round"
          stroke-width="2" transform="translate(-4,1)" x1="0" x2="0" y1="0" y2="8" />
        <line class="am-weather-rain-2" fill="none" stroke="#91C0F8" stroke-dasharray="4,4" stroke-linecap="round"
          stroke-width="2" transform="translate(0,-1)" x1="0" x2="0" y1="0" y2="8" />
        <line class="am-weather-rain-1" fill="none" stroke="#91C0F8" stroke-dasharray="4,4" stroke-linecap="round"
          stroke-width="2" transform="translate(4,0)" x1="0" x2="0" y1="0" y2="8" />
      </g>
    </g>
    <g id="rain-2" v-else-if="rain >= 2">
      <g transform="translate(30,42), rotate(10)">
    ...
    <g id="rain-1" v-else-if="rain >= 1">
      <g transform="translate(33,41), rotate(10)">
        <line class="am-weather-rain-1" fill="none" stroke="#91C0F8" stroke-dasharray="4,7" stroke-linecap="round"
          stroke-width="2" transform="translate(-6,1)" x1="0" x2="0" y1="0" y2="8" />
      </g>
    </g>
    <g id="snow-3" v-if="snow >= 3">
      <g transform="translate(16,6)">
    ...
    <g id="hail" v-if="hail">
      <g transform="translate(27,42), rotate(10)">
        <line class="am-weather-rain-1" fill="none" stroke="#91C0F8" stroke-dasharray="0.1,7" stroke-linecap="round"
          stroke-width="3" transform="translate(-5,1)" x1="0" x2="0" y1="0" y2="8" />
        <line class="am-weather-rain-2" fill="none" stroke="#91C0F8" stroke-dasharray="0.1,7" stroke-linecap="round"
          stroke-width="3" transform="translate(0,-1)" x1="0" x2="0" y1="0" y2="8" />
        <line class="am-weather-rain-1" fill="none" stroke="#91C0F8" stroke-dasharray="0.1,7" stroke-linecap="round"
          stroke-width="3" transform="translate(5,0)" x1="0" x2="0" y1="0" y2="8" />
      </g>
    </g>
    <g id="stroke" v-if="stroke">
      <g transform="translate(16,6)">
